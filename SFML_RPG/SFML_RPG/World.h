...
public:
	...
	void createForestEnemies();
	void createForest2Enemies();
	void createBeachEnemies();
	void createWaterfallEnemies();
	void createWFBossRoomEnemies();
	void createGraveyardEnemies();
	void createGhostShedEnemies();
	void createWFCorridorEnemies();
	void createPortEnemies();

	void selectEnemyCreation(int location);
